...
//土语核金弹头
$CONFIG['GamesData']['mwpt'] = array(
    'name'         => 'Metal War',
    'ico'          => $CONFIG['cdn'] . 'static/games/mwpt/icon.jpg',
    'serverbgpic'  => $CONFIG['cdn'] . 'static/games/mwpt/list.jpg', //服务器列表背景图片
    'accountbgpic' => $CONFIG['cdn'] . 'static/games/mwpt/account.jpg',    //账号多开背景图片
    'url'          => '//odp.oasgames.com/api/?m=serverlist&game_code=mwpt&type=oas_get_server&uid={uid}',
    'login_css'    => $CONFIG['cdn'] . 'static/css/oas.float.css',
    'login_skin'   => '2'
);
...
//土语新神曲20170309
$CONFIG['GamesData']['lortr'] = [
    'name'          => 'Legend Online Reborn',
    'ico'           => $CONFIG['cdn'] . 'static/games/lortr/logo.ico',
    'serverbgpic'   => $CONFIG['cdn'] . 'static/games/lortr/list.jpg', //服务器列表背景图片
    'accountbgpic'  => $CONFIG['cdn'] . 'static/games/lortr/lortr.jpg',    //账号多开背景图片
    'url'           => '//odp3.oasgames.com/api/game/serverlist?gamecode=lortr&uid={uid}',
    'openGamesFlag' => 1,  //控制是否启用游戏中心页面或者直接打开游戏  1 -> 打开游戏  0 -> 打开游戏中心
    'login_css'     => $CONFIG['cdn'] . 'static/css/oas.login.css',
    'login_skin'    => '2',
    'getNewsUrl'    => '//odp3.oasgames.com/api/game/gbox-news?gamecode=lortr'
];
