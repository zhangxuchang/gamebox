...
GSY.config.set('file',GSY.gamebox.getVerion(GSY.util.getUrlParam('version')));
...
GSY.config.set('path',GSY.config.get('host') + 'gamebox/'+ GSY.config.get('file') +'/template/{pagename}.php');
...
if(GSY.config.get('file') == '2.0.0'){
	GSY.config.set('smallgamefile','1.1.4');
}else{
	GSY.config.set('smallgamefile',GSY.config.get('file'));
}
