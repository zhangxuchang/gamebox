		...
		<div class="gb-dialog-login-t-c">
			<div class="gb-dialog-login-t-box" data-selecter="parent" data-type="oas">
				<ul>
					...
					<li style="padding-left:85px;"><a href="javascript:void(0);" onclick="GSY.gamebox.login($(this),'login_dialog');return false;" class="gb-btn-green"><span><em><script type="text/javascript">OASWriteContent('Gamebox_Login');</script></em></span></a></li>
