...
duma.BeautifyScrollBar = function(obj, arrowUpCss, arrowUpActiveCss, handleCss, handleActiveCss, arrowDownCss, arrowDownActiveCss) {
    ...
    this.barHeight = this.area.offsetHeight;
    this.barPos;
...
duma.BeautifyScrollBar.prototype = {
    ...
    barScroll: function(e) {
        var e = e || window.event,
            eDir; //设置滚轮事件,e.wheelDelta与e.detail分别兼容IE、W3C，根据返回值的正负来判断滚动方�?
        if (e.wheelDelta) {
    ...
    run: function() {
        ...
        if(this.barHeight < this.areaScrollHeight){
            ...
            duma.bind(this.obj, 'mouseover',function(event){
                that.bar.style.display = 'block';
            });
            duma.bind(this.obj, 'mouseleave',function(){
